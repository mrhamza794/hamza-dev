          ...
          {step === "credentials" && (
            <>
              <button
                ...
                className="mb-6 flex w-full items-center justify-center gap-3 rounded-xl border border-slate-200 bg-white py-3.5 font-semibold text-slate-800 shadow-sm transition-all hover:bg-slate-50 disabled:opacity-60 dark:border-white/10 dark:bg-white/5 dark:text-white dark:hover:bg-white/10"
              >
                {isGoogleLoading ? (
                  <div className="h-5 w-5 animate-spin rounded-full border-2 border-slate-300 border-t-purple-500" />
                ) : (
                  <>
                    <FcGoogle size={22} />
              ...
              <div className="mb-6 flex items-center gap-3">
                ...
                <span className="text-xs font-medium text-slate-400">or email & password</span>
                <div className="h-px flex-1 bg-slate-200 dark:bg-white/10" />
              </div>
            </>
          )}
            ...
            {step === "credentials" && (
              ...
              >
                <p className="mb-6 text-center text-sm text-slate-600 dark:text-slate-300">
                  Sign in with admin email and password, then verify OTP
                </p>
