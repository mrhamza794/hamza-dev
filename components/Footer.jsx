...
const Footer = () => {
  ...
  return (
    <footer className="relative w-full glass-card bg-black/60! backdrop-blur-xl border-t border-white/10 rounded-none! overflow-hidden">
      {/* Background Decor */}
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-purple-900/20 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="container mx-auto px-6 py-16 max-w-[1400px] relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-8 mb-16">
          ...
          <div className="flex flex-col gap-4">
            <h3 className="text-white font-space font-bold text-xl mb-2">Navigate</h3>
              ...
              {['About', 'Skills', 'Projects', 'Contact'].map((item) => (
                <li key={item}>
                  <a 
                    ...
                    className="text-slate-400 hover:text-white transition-colors flex items-center gap-2 group w-fit"
                  >
          ...
          {/* Column 3: Connect */}
          <div className="flex flex-col gap-4">
            <h3 className="text-white font-space font-bold text-xl mb-2">Connect</h3>
            ...
            <a 
               ...
               className="w-fit glass-card px-6 py-3 rounded-xl bg-linear-to-r from-purple-600/20 to-blue-600/20 border-white/10! hover:border-purple-500/50! font-bold text-white text-sm hover:scale-105 transition-all text-center"
            >
               Let's work together
            </a>
          </div>
